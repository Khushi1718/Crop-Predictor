...
models = {
    "KNN": joblib.load(BASE_DIR / "models/KNN_model.pkl"),
    "SVM": joblib.load(BASE_DIR / "models/SVM_model.pkl"),
    "DecisionTree": joblib.load(BASE_DIR / "models/DecisionTree_model.pkl"),
    "RandomForest": joblib.load(BASE_DIR / "models/RandomForest_model.pkl")
}

# Load regression model
regressor = joblib.load(BASE_DIR / "models/regressor_model.pkl")
